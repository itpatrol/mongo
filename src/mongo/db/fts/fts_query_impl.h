...
public:
    ...
    const std::set<std::string>& getTermsOutOfPhrasesForBounds() const {
        return _termsOutOfPhrasesForBounds;
    }
...
private:
    ...
    void _addSoloTerms(FTSTokenizer* tokenizer, const std::string& tokens, bool negated);
    ...
    std::set<std::string> _termsOutOfPhrasesForBounds;
